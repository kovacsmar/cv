...
**System Administrator | Scientific Games Kft.** _2023 – 2025_

- **Platform Ops:** Operated microservice-based applications in Red Hat OpenShift and Docker environments.
- **Linux Admin:** Managed production RHEL servers, automating routine tasks with Bash and Python scripts.
- **DB Admin:** Administered Oracle databases across production and test environments.

**Command Center / Datacenter Operator | Invitech ICT Services Kft.** _2020 – 2023_
